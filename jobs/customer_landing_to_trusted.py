...
CustomerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://udacity-stedi-data-lakehouse/customer/landing/"],
        "recurse": True,
    },
    transformation_ctx="CustomerLanding_node1",
)

# Script generated for node Filter Sharing Privacy
FilterSharingPrivacy_node2 = Filter.apply(
    frame=CustomerLanding_node1,
    f=lambda row: (not (row["shareWithResearchAsOfDate"] == 0)),
    transformation_ctx="FilterSharingPrivacy_node2",
)

# Script generated for node Customer Trusted
CustomerTrusted_node3 = glueContext.getSink(
    path="s3://udacity-stedi-data-lakehouse/customer/trusted/",
    connection_type="s3",
...
CustomerTrusted_node3.writeFrame(FilterSharingPrivacy_node2)
job.commit()
